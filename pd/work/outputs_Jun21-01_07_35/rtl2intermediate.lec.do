...
# Generated on: Sat Jun 21 01:34:29 IST 2025 (Fri Jun 20 20:04:29 UTC 2025)
...
set logfile logs_Jun21-01:07:35/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Hybrid_Decryption_Top -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/AES_Decryption_top.v ../rtl/decLastround.v ../rtl/DecryAdd_RoundKey.v ../rtl/DecrypRounds.v ../rtl/ECC_Decryption.v ../rtl/g_function.v ../rtl/Hybrid_Decryption_top.v ../rtl/InverseMixColumn.v ../rtl/Inverse_SBOX.v ../rtl/InverseShiftRows.v ../rtl/InverseSubBytes.v ../rtl/Key_Expantion.v ../rtl/S_Box.v
elaborate_design -golden -root {Hybrid_Decryption_Top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Hybrid_Decryption_Top/fv_map.v.gz
...
#add_name_alias fv/Hybrid_Decryption_Top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Hybrid_Decryption_Top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Hybrid_Decryption_Top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Hybrid_Decryption_Top.rtl.fv_map.rpt
