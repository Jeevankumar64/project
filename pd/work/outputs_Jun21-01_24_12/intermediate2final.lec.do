...
# Generated on: Sat Jun 21 01:44:39 IST 2025 (Fri Jun 20 20:14:39 UTC 2025)
...
set logfile logs_Jun21-01:24:12/intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_Hybrid_Decryption_Top_mv_db

read_implementation_information fv/Hybrid_Decryption_Top -golden fv_map -revised Hybrid_Decryption_Top_mv
...
read_library -liberty -both \
    /home/vivarthan/Music/Project_major/Hybrid_aes_ecc/decryption/pd/work/../library/fast.lib \
    /home/vivarthan/Music/Project_major/Hybrid_aes_ecc/decryption/pd/work/../library/slow.lib

read_design -verilog95   -golden -lastmod -noelab fv/Hybrid_Decryption_Top/fv_map.v.gz
elaborate_design -golden -root {Hybrid_Decryption_Top}

read_design -verilog95   -revised -lastmod -noelab outputs_Jun21-01:24:12/Hybrid_Decryption_Top_m.v
elaborate_design -revised -root {Hybrid_Decryption_Top}

#add_name_alias fv/Hybrid_Decryption_Top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/Hybrid_Decryption_Top/Hybrid_Decryption_Top_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.Hybrid_Decryption_Top.fv_map.Hybrid_Decryption_Top_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Hybrid_Decryption_Top.fv_map.Hybrid_Decryption_Top_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.Hybrid_Decryption_Top.fv_map.Hybrid_Decryption_Top_mv.rpt
